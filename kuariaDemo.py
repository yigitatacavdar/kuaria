...
def networkScannerFunc(subnetInput):

    nm = nmap.PortScanner()
    nm.scan(hosts=subnetInput, arguments='-T4 -F -O -sV')
...
subnetInput = input("Enter the subnet you want to work with: ")

networkScannerFunc(subnetInput)
